    ...
    methods: {
      ...
      getBoardList () {
        ...
        api.getBoardList(offset, this.limit, this.query).then(res => {
          ...
          this.freeBoard = res.data.data.results
          if (this.isAuthenticated) {
            this.addStatusColumn(this.freeBoardTableColumns, res.data.data.results)
          }
        }, res => {
          this.loadings.table = false
        })
